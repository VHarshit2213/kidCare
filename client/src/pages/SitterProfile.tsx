          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-8 border-t border-neutral-200 pt-8">
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center">
                  <div className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${sitter.yearsExperience >= 2 ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-400'}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-neutral-500">{sitter.yearsExperience} years</p>
                  </div>
                </div>
              </div>
            </div>
